                                            ...
                                            <div class="col auto">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-900">
                                                    <?php  
                                                        ...
                                                        $sql = "SELECT SUM(sub_total) as total from sales_fact sf JOIN time t ON sf.time_id=t.time_id  where t.tahun = 2003";
                            ...
                            <div class="col-xl-3 col-md-6 mb-4">
                                <div class="card border-left-success shadow h-100 py-2">
                                    <div class="card-body">
                                        <div class="row no-gutters align-items-center">
                                            <div class="col auto">
                                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Total kuantitas barang yang dibeli pada Tahun 2003</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                    <?php
                                                        $sql = "SELECT SUM(sf.order_qty) total, t.tahun FROM sales_fact sf JOIN time t ON sf.time_id = t.time_id WHERE t.tahun=2003;";
                                                        $query = mysqli_query($mysqli,$sql);
                                                        while($row2=mysqli_fetch_array($query)){
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col auto">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-900">
                                                    <?php  
                                                        $mysqli = mysqli_connect("localhost","root","","adventureworks2022");
                                                        $sql = "SELECT SUM(sf.sub_total) total from sales_fact sf JOIN product p ON sf.product_id=p.product_id where p.category = 'Bikes';";
                                                        $query = mysqli_query($mysqli,$sql);
                                                        while($row2=mysqli_fetch_array($query)){
                                                            echo "$".number_format($row2['total']);
                                                        }
