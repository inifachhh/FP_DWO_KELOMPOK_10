                                        ...
                                        <div class="col auto">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-900">
                                                <?php  
                                                    ...
                                                    $sql = "SELECT SUM(sub_total) as total from sales_fact";
                    ...
                    <!-- Content Row 2 OLAP -->
                     ...
                     <div class="card shadow mb-4">
                            ...
                            <div class="collapse" id="collapseCardExample">
                                <div class="card-body">
                                    <iframe name="mondrian" src="http://localhost:8080/mondrian/testpage.jsp?query=dwoadw1" style="height: 500px;; width:100%; border:none; align-content:center"> </iframe>
                                </div>
                            </div>
                    </div>
